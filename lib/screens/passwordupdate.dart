...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: PassWordUpdate1(),
    );
  }
}

class PassWordUpdate1 extends StatefulWidget {
  const PassWordUpdate1({super.key});

  @override
  _PassWordUpdate1State createState() => _PassWordUpdate1State();
}

class _PassWordUpdate1State extends State<PassWordUpdate1> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        buildKeyContainer('Space', width: screenWidth * 0.45, color: const Color(0xFFFCFCFE), onTap: () => updatePassword(" ")),
                        buildKeyContainer('Go', width: screenWidth * 0.22, color: const Color(0xFF898A8D)),
                      ],
                    ),
        SizedBox(height: MediaQuery.of(context).size.height * 0.018), // Adjusting height proportionally
           Positioned(
  left: 0,
  right: 0,
  bottom: MediaQuery.of(context).size.height * 0.08, // Adjust bottom margin proportionally
  child: Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween, // Space icons evenly across
    children: [
      // Smiley Icon positioned below the '123' button
      Padding(
        padding: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.056), // Adjusting left padding
        child: Icon(
          Icons.sentiment_satisfied_alt_outlined,
          size: MediaQuery.of(context).size.width * 0.08, // Adjusting icon size proportionally
          color: const Color(0xFF50555C),
        ),
      ),
      // Mic Icon positioned below the 'Go' button
      Padding(
        padding: EdgeInsets.only(right: MediaQuery.of(context).size.width * 0.056), // Adjusting right padding
        child: Icon(
          Icons.mic,
          size: MediaQuery.of(context).size.width * 0.08, // Adjusting icon size proportionally
          color: const Color(0xFF50555C),
